...
git clone https://github.com/swo-cesar-lopez/swo-gpt-rag-ingestion ./.azure/gpt-rag-ingestion
...
# Clone the repository into the .azure folder
git clone https://github.com/swo-cesar-lopez/swo-gpt-rag-orchestrator ./.azure/gpt-rag-orchestrator
...
# Clone the repository into the .azure folder
git clone https://github.com/swo-cesar-lopez/swo-gpt-rag-frontend ./.azure/gpt-rag-frontend
